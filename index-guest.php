...
<body>
  ...
  <header id="header" class="fixed-top">
      ...
      <nav>
      <div class="logo">FreeLance</div>
      <input type="checkbox" id="click">
      <label for="click" class="menu-btn">
        <i class="fas fa-bars"></i>
      </label>
      <ul>
<li><a class="active" href="index-guest.php">Home</a></li>
...
<li><a href="login.php">Login</a></li>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="d-flex">
    <a href="login.php" class="btn-get-started scrollto"><span>Hire Talents</span></a>
        <a href="login.php" class="btn-get-started scrollto ml-3"><span>Find Jobs</span></a>
              </div>
   
      <h1>You Can Find the Best <span>Jobs</span> <br>Or <span>Hire Talents</span> 
      </h1>
      ...
      <div class="section-title">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            ...
            <p>
            <i class="fas fa-angle-double-left"></i>          
                I love to deal with this site for 5 years because I gained experience in my field and made many projects           <i class="fas fa-angle-double-right"></i>
          ...
          <div class="testimonial-item">
            ...
            <p>
            <i class="fas fa-angle-double-left"></i> 
              I love to deal with this site for 7 years because I gained experience in my field and made many projects           <i class="fas fa-angle-double-right"></i>
              <i class="fas fa-angle-double-right"></i>
            </p>
          </div>
          ...
          <div class="testimonial-item">
            ...
            <p>
            <i class="fas fa-angle-double-left"></i> 
              I love to deal with this site for 4 years because I gained experience in my field and made many projects           <i class="fas fa-angle-double-right"></i>
              <i class="fas fa-angle-double-right"></i>
            </p>
          </div>
          ...
          <div class="testimonial-item">
            ...
            <p>
            <i class="fas fa-angle-double-left"></i> 
              I love to deal with this site for 3 years because I gained experience in my field and made many projects           <i class="fas fa-angle-double-right"></i>
              <i class="fas fa-angle-double-right"></i>
            </p>
          </div>
        </div>
