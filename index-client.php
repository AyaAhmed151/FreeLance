...
<body>
  ...
  <section id="hero" class="d-flex align-items-center">
    ...
    <div class="d-flex">
    <a href="my-jobs.php" class="btn-get-started scrollto"><span>My Jobs</span></a>
        <a href="top-freelancers.php" class="btn-get-started scrollto ml-3"><span>Top Freelancer</span></a>
              </div>
