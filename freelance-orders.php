...
<header id="header" class="fixed-top">
  ...
  <div class="mt-3 heading-info">
        ...
        <?php
            ...
            $query = "SELECT * FROM freelance_orders WHERE freelancer_name = '$user_name' ";
          ...
          if($check){
            while($row = mysqli_fetch_array($result))
            {
                ...
                print "<h4 class='card-title mt-3'> Name: ". $row['uname'] ."</h4>";
                ...
                print "<h4 class='card-title mt-3'> Description: ". $row['C_description'] ."</h4>";
