...
session_start();
    ...
    if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if(!empty($first_name) && !empty($last_name) && !empty($email) && !empty($password) && !empty($user_name) && !empty($phone) && !empty($work_type) && !empty($user_role)) {
            //save to database
            $user_id = random_num(20);
            $query = "insert into users (user_id,firstname,lastname,email,password,user_name,phone,work_type,user_role,profile_pic) values ('$user_id','$first_name','$last_name','$email', '$password','$user_name','$phone','$work_type','$user_role','$profile_pic')";
...
<li><a href="index-guest.php#about">About</a></li>
<li><a href="index-guest.php#services">FeedBack</a></li>
<li><a href="index-guest.php#contact">Contact</a></li>
<li><a href="signup.php">Register</a></li>
<li><a href="login.php">Login</a></li>
    ...
    <section style="margin-top: 100px;" id="signup-form">
    <div class="container mt-3" style="max-width: 700px;">
        ...
        <label for="fileToUpload">Choose Your Profile: </label><br>
